...
class AttentionEncoder(nn.Module):
    def __init__(self,num_heads=4,d_model = 512,ff_dim=512,n_encoder_layers = 2,seq_length = 5,dropout = .1):
        ...
        # define the mask:
        self.mask = self._generate_square_subsequent_mask(seq_length)
    ...
    def forward(self,x):
        ...
        # current batch is of type (batch_size, seq_size,vector)
        # need to swap to (seq,batch,vector)
        x = x.permute(1, 0, 2)
